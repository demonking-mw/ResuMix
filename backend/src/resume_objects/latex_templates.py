...
class LTemplate:
    ...
    def item_builder(
        ...
        section_style_name: str = "default",
    ) -> list:
        """
    ...
    def resume_builder(self, resume_object: "Resume") -> bytes:
        ...
        master_frame = Frame(
            margin_l, margin_b, A4[0] - margin_l - margin_r, A4[1] - margin_t - margin_b
        )
