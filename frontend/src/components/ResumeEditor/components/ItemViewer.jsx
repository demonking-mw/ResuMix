...
const ItemViewer = ({
  ...
  // FIXED: Only check if titles array doesn't exist or is empty, not if values are empty
  const hasNoTitles = !item.titles || item.titles.length === 0;
                ...
                return (
                  <div className="formatted-titles">
                    ...
                    <div className="title-row title-row-1">
                      ...
                      {formattedTitles.row1.right !== null && (
                    ...
                    {formattedTitles.row2 && (
                      <div className="title-row title-row-2">
                        ...
                        {formattedTitles.row2.right !== null && (
                          <div className="title-right">
                            {mode === "edit" ? (
                              <input
                                type="text"
